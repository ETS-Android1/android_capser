    ...
    private void initialize() {
        ...
        autoCompleteTextView.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, serverUrl + s.toString(), response -> {
        ...
        SharedPreferences accessPreferences = getSharedPreferences(getResources().getString(R.string.access_token), MODE_PRIVATE);
        ...
        addGameButton.setOnClickListener(l -> {
            ...
            if(opponentId == null){
                Toast toast = Toast.makeText(getApplicationContext(),"You must select an opponent", Toast.LENGTH_SHORT);
                toast.show();
                return;
            }
